...
[`credentials.PerRPCCredentials`](https://godoc.org/github.com/oodle-ai/grpc-go/credentials#PerRPCCredentials).
...
https://godoc.org/github.com/oodle-ai/grpc-go/credentials/oauth for details.
...
[`WithPerRPCCredentials`](https://godoc.org/github.com/oodle-ai/grpc-go#WithPerRPCCredentials).
Or, if user wants to apply OAuth token per call, then configure the grpc RPC
call with `CallOption`
[`PerRPCCredentials`](https://godoc.org/github.com/oodle-ai/grpc-go#PerRPCCredentials).
