...
import (
	...
	_ "github.com/oodle-ai/grpc-go/balancer/grpclb"               // grpclb for config parsing.
	_ "github.com/oodle-ai/grpc-go/internal/resolver/passthrough" // passthrough resolver.
)
