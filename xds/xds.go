...
import (
	...
	internaladmin "github.com/oodle-ai/grpc-go/internal/admin"
	"github.com/oodle-ai/grpc-go/resolver"
	"github.com/oodle-ai/grpc-go/xds/csds"

	_ "github.com/oodle-ai/grpc-go/credentials/tls/certprovider/pemfile"           // Register the file watcher certificate provider plugin.
	_ "github.com/oodle-ai/grpc-go/xds/internal/balancer"                          // Register the balancers.
	_ "github.com/oodle-ai/grpc-go/xds/internal/clusterspecifier/rls"              // Register the RLS cluster specifier plugin. Note that this does not register the RLS LB policy.
	_ "github.com/oodle-ai/grpc-go/xds/internal/httpfilter/fault"                  // Register the fault injection filter.
	_ "github.com/oodle-ai/grpc-go/xds/internal/httpfilter/rbac"                   // Register the RBAC filter.
	...
	_ "github.com/oodle-ai/grpc-go/xds/internal/xdsclient/xdslbregistry/converter" // Register the xDS LB Registry Converters.
