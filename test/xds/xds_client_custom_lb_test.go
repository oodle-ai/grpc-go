...
import (
	...
	_ "github.com/oodle-ai/grpc-go/balancer/leastrequest"       // To register least_request
	_ "github.com/oodle-ai/grpc-go/balancer/weightedroundrobin" // To register weighted_round_robin
